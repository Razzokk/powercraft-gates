...
public final class WorldUtils
{
	...
	{
		return ObjectUtils.cast(world.getBlockEntity(pos), clazz);
	}

	public static <T> boolean ifTilePresent(World world, BlockPos pos, Class<T> clazz, Consumer<T> consumer)
	{
		return ObjectUtils.ifCastable(world.getBlockEntity(pos), clazz, consumer);
	}

	public static <T, U> U mapTile(World world, BlockPos pos, Class<T> clazz, Function<T, U> function)
	{
		return ObjectUtils.mapIfCastable(world.getBlockEntity(pos), clazz, function);
	}
}
